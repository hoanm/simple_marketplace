...
// wasm folder
const wasmFolder = `${__dirname}/../celer_wasms`;
...
async function main() {
    ...
    //     if (contract_names[i] == "bridge") {
    //         console.log("Storing bridge contract code...");
    //         let storeCodeResponse = await store_contract(contract_names[i]);
    //         bridge_code_id = storeCodeResponse.codeId;
    //     } else if (contract_names[i] == "pegbridge") {
    //         console.log("Storing pegbridge contract code...")
    //         let storeCodeResponse = await store_contract(contract_names[i]);
    //         pegbridge_code_id = storeCodeResponse.codeId;
    //     } else if (contract_names[i] == "vault") {
    //         console.log("Storing vault contract code...")
    //         let storeCodeResponse = await store_contract(contract_names[i]);
    //         vault_code_id = storeCodeResponse.codeId;
    //     } else if (contract_names[i] == "token") {
    ...
    // // instantiate contract halo_factory
    ...
    const tokenInstantiateMsg = {
        ...
        "initial_balances": [
            {
                "address": "aura1uaflg8e46wwtvm0td8mkjeaa0d5s53c92dj85r",
    ...
    let tokenInstantiateResponse = await instantiate(17, tokenInstantiateMsg);

    // // Print out the result
    // console.log("Contract store information:");
    // console.log("bridge contract code id: ", bridge_code_id);
    // console.log("pegbridge contract code id: ", pegbridge_code_id);
    // console.log("vault contract code id: ", vault_code_id);
    console.log(tokenInstantiateResponse);
    // console.log("Celer storing completed!")
}
