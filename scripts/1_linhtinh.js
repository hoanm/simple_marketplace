...
async function main() {
    ...
    receipeintWallet = "aura1uaflg8e46wwtvm0td8mkjeaa0d5s53c92dj85r";

    deployerClient.sendTokens(deployerAccount.address, receipeintWallet, [coin("23740534081", "ueaura")], "auto");
}
